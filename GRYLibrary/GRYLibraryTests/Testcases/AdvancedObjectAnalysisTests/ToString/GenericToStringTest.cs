...
namespace GRYLibrary.Tests.Testcases.AdvancedObjectAnalysisTests.ToString
{
    ...
    public class GenericToStringTest
    {
        ...
        public void SimpleDataStructureTestObjectToString()
        {
            ...
            string expectedString = @"{ (ObjectId: 2, Type: GRYLibrary.Tests.TestData.TestTypes.SimpleDataStructure.SimpleDataStructure1) 
  Property1: 
  [
    { (ObjectId: 1, Type: GRYLibrary.Tests.TestData.TestTypes.SimpleDataStructure.SimpleDataStructure3) 
      Property4: 
